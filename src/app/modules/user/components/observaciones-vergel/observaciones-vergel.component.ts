...
@Component({
  ...
  templateUrl: './observaciones-vergel.component.html',
  styleUrl: './observaciones-vergel.component.css'
})
export class ObservacionesVergelComponent implements OnInit{
  ...
  listarObservaciones(): void {
    this.observacionService.getObservacionesVergel().subscribe(
      (lista: Observacion[]) => {
  ...
  guardarObservacion() {
    ...
    this.observacionService.guardarVergel(this.observacion).subscribe({
  ...
  agregarCorreccion() {
    ...
    this.observacionService.agregarCorreccionVergel(this.obCorr).subscribe(
      data => {
        if (data) {
          this.listarObservaciones();
          this.novedad = '';
